...
namespace DiGi.Typology.xUnit
{
    public partial class Facts
    {
        ...
        public void Typology_Clone()
        {
            ...
            Typology.Classes.Typology? typology_GrandChild_Copy = typology_Copy.GetTypology([1, 1]);
            ...
            Assert.Equal(2, typology_Copy.GetReferences(true).Count);
            Assert.Single(typology.GetReferences(true));

            Typology.Classes.Typology typology_Composed = new(new Typology.Classes.TypologyItem([9], "Composed", null), [typology_GrandChild]);

            Typology.Classes.Typology? typology_Composed_Child = typology_Composed.GetTypology([1]);
            ...
            Assert.Single(typology_Clone.GetReferences(true));
            Assert.Equal("GrandChild", typology_Clone.GetTypology([1, 1])?.Name);
