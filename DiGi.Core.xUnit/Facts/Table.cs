...
namespace DiGi.Core.xUnit
{
    public partial class Facts
    {
        ...
        public void Table_TryGetValue_ShouldReturnCorrectValueAndTrue()
        {
            ...
            // Act
            bool result = table.TryGetValue(0, 0, out string? value);
        ...
        /// <summary>
        /// Verifies that the <see cref="IO.Table.Classes.Table"/>'s UpdateRow method correctly updates a row's cells when provided with a dictionary containing string keys and corresponding values.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Verifies that the <see cref="IO.Table.Classes.Table"/>'s UpdateRow method correctly updates a row's cells when provided with an enumerable collection of values.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Verifies that the <see cref="IO.Table.Classes.Table"/>'s UpdateRow method correctly updates a row's cells when provided with a dictionary where keys are integer column indices.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Verifies that the <see cref="Table.UpdateColumn"/> method correctly updates only the name of a column when the provided type remains unchanged.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Verifies that the <see cref="IO.Table.Classes.Table"/>'s GetRow method returns the expected result when provided with both valid and invalid indices.
        /// </summary>
        [Fact]
