...
namespace DiGi.Geometry.xUnit
{
    public partial class Classes
    {
        ...
        public void ProjectionResult_Ellipse3D()
        {
            ...
            Vector3D vector3D_TiltedNormal = new(1.0 / Math.Sqrt(2), 0, 1.0 / Math.Sqrt(2));
            ...
            Vector3D vector3D_NearPerpNormal = new(Math.Cos(0.001 * Math.PI / 180.0), 0, Math.Sin(0.001 * Math.PI / 180.0));
