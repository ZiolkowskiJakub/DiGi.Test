...
namespace DiGi.Geometry.xUnit
{
    public partial class Query
    {
        ...
        {
            Point2D point2D_1 = new Point2D(0, 0);
            Point2D point2D_2 = new Point2D(3, 4); // Distance should be sqrt(3^2 + 4^2) = 5
        ...
        {
            Point2D point2D_Start = new Point2D(0, 0);
            Point2D point2D_End = new Point2D(10, 10);

            Segment2D segment2D_1 = new Segment2D(point2D_Start, point2D_End);
            Segment2D segment2D_2 = new Segment2D(point2D_Start, point2D_End);
            Segment2D segment2D_Reversed = new Segment2D(point2D_End, point2D_Start);
            Segment2D segment2D_Different = new Segment2D(point2D_Start, new Point2D(5, 5));
        ...
        {
            Point2D point2D_Min = new Point2D(-5, -5);
            Point2D point2D_Max = new Point2D(5, 5);
            BoundingBox2D boundingBox2D = new BoundingBox2D(point2D_Min, point2D_Max);
        ...
        public void BoundingBox2D_InRange_Correctness()
        {
            ...
            Line2D line2D_Through = new Line2D(new Point2D(-10, 0), new Vector2D(1, 0));
            Assert.True(boundingBox2D.InRange(line2D_Through));

            // 2. Line missing AABB
            Line2D line2D_Miss = new Line2D(new Point2D(-10, 10), new Vector2D(1, 0));
            Assert.False(boundingBox2D.InRange(line2D_Miss));

            // 3. Segment completely inside AABB
            Segment2D segment2D_Inside = new Segment2D(new Point2D(-2, -2), new Point2D(2, 2));
            Assert.True(boundingBox2D.InRange(segment2D_Inside));

            // 4. Segment outside AABB but aligned
            Segment2D segment2D_Outside = new Segment2D(new Point2D(10, 0), new Point2D(15, 0));
        ...
        public void Segment_Segment_Intersection_Correctness()
        {
            ...
            Segment2D segment2D_1 = new Segment2D(new Point2D(-2, 0), new Point2D(2, 0));
            Segment2D segment2D_2 = new Segment2D(new Point2D(0, -2), new Point2D(0, 2));
            ...
            Segment2D segment2D_Parallel1 = new Segment2D(new Point2D(-2, 0), new Point2D(2, 0));
            Segment2D segment2D_Parallel2 = new Segment2D(new Point2D(-2, 2), new Point2D(2, 2));
            ...
            Segment2D segment2D_Collinear1 = new Segment2D(new Point2D(0, 0), new Point2D(4, 0));
            Segment2D segment2D_Collinear2 = new Segment2D(new Point2D(2, 0), new Point2D(6, 0));
            ...
            Segment2D segment2D_Adjacent1 = new Segment2D(new Point2D(0, 0), new Point2D(2, 2));
            Segment2D segment2D_Adjacent2 = new Segment2D(new Point2D(2, 2), new Point2D(4, 0));
        ...
        {
            Segment2D segment2D_Source = new Segment2D(new Point2D(0, -5), new Point2D(0, 5));
        ...
        public void PolygonalFace_Linear_Intersection_Correctness()
        {
            ...
            Line2D line2D_Through = new Line2D(new Point2D(0, -10), new Vector2D(0, 1));
