...
namespace DiGi.Geometry.xUnit
{
    public partial class Query
    {
        ...
        public void Union_CascadedOverlap()
        {
            ...
            var result = Planar.Query.Union<Polygon2D>([p1, p2, p3, p4]);
            Assert.NotNull(result);
