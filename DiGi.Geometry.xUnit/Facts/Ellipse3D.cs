namespace DiGi.Geometry.xUnit
{
    public partial class Facts
    {
        ...
        {
            Spatial.Classes.Plane plane_XY = new(new Spatial.Classes.Point3D(0.0, 0.0, 0.0), new Spatial.Classes.Vector3D(0.0, 0.0, 1.0));
            Planar.Classes.Ellipse2D ellipse2D_Base = new(new Planar.Classes.Point2D(0.0, 0.0), 5.0, 10.0);
            Spatial.Classes.Ellipse3D ellipse3D_Main = new(plane_XY, ellipse2D_Base);

            Spatial.Classes.Point3D point3D_Inside = new(1.0, 2.0, 0.0);
            Spatial.Classes.Point3D point3D_Outside = new(6.0, 0.0, 0.0);
            Spatial.Classes.Point3D point3D_OffPlane = new(1.0, 2.0, 1.0);
