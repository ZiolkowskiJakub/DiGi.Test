...
namespace DiGi.Geometry.xUnit
{
    public partial class Facts
    {
        ...
        public void Centroid()
        {
            ...
            Point3D? point3D_ResultNull = Spatial.Query.Centroid(point3Ds_Null);
            Assert.Null(point3D_ResultNull);

            // Empty input
            List<Point3D> point3Ds_Empty = [];
            Point3D? point3D_ResultEmpty = Spatial.Query.Centroid(point3Ds_Empty);
            Assert.Null(point3D_ResultEmpty);

            // Single point
            Point3D point3D_Single = new(1.0, 2.0, 3.0);
            List<Point3D> point3Ds_One = [point3D_Single];
            Point3D? point3D_ResultOne = Spatial.Query.Centroid(point3Ds_One);
            ...
            Point3D? point3D_ResultTwo = Spatial.Query.Centroid(point3Ds_Two);
            ...
            Point3D? point3D_ResultThree = Spatial.Query.Centroid(point3Ds_Three);
            ...
            Point3D? point3D_ResultFour = Spatial.Query.Centroid(point3Ds_Four);
