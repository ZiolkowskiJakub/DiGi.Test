namespace DiGi.Geometry.xUnit
{
    public partial class Facts
    {
        ...
        public void Ray3D_Project()
        {
            ...
            Spatial.Classes.Ray3D ray3D_Test = new(point3D_Origin, vector3D_Direction);

            // Test projection of point in front of the origin
            Spatial.Classes.Point3D? point3D_ProjFront = ray3D_Test.Project(new Spatial.Classes.Point3D(3.0, 4.0, 10.0));
            Assert.NotNull(point3D_ProjFront);
            if (point3D_ProjFront is not null)
            {
                Assert.Equal(point3D_ProjFront, new Spatial.Classes.Point3D(0.0, 0.0, 10.0));
            }

            // Test projection of point behind the origin (should clamp to origin)
            Spatial.Classes.Point3D? point3D_ProjBehind = ray3D_Test.Project(new Spatial.Classes.Point3D(3.0, 4.0, -10.0));
            Assert.NotNull(point3D_ProjBehind);
            if (point3D_ProjBehind is not null)
            {
                Assert.Equal(point3D_ProjBehind, new Spatial.Classes.Point3D(0.0, 0.0, 0.0));
            }

            // Test Distance method for point in front
            double double_DistFront = ray3D_Test.Distance(new Spatial.Classes.Point3D(3.0, 4.0, 10.0));
            ...
            double double_DistBehind = ray3D_Test.Distance(new Spatial.Classes.Point3D(3.0, 4.0, -10.0));
            ...
            bool bool_OnRay = ray3D_Test.On(new Spatial.Classes.Point3D(0.0, 0.0, 5.0));
            Assert.True(bool_OnRay);

            // Test On method for point behind the ray's origin (should return false)
            bool bool_BehindRay = ray3D_Test.On(new Spatial.Classes.Point3D(0.0, 0.0, -5.0));
        ...
        {
            Spatial.Classes.Point3D point3D_Origin = new(1.0, 2.0, 3.0);
            Spatial.Classes.Vector3D vector3D_Direction = new(0.0, 0.0, 1.0);
            Spatial.Classes.Ray3D ray3D_Target = new(point3D_Origin, vector3D_Direction);
