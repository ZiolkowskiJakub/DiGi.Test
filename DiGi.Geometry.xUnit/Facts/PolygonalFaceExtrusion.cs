    ...
    public partial class Facts
    {
        ...
        public void PolygonalFaceExtrusion()
        {
            ...
            for (int i = 0; i < polyhedron.Count; i++)
            {
                ...
                Spatial.Classes.Vector3D? normal_Internal = polyhedron.GetNormal(i, Core.Enums.Side.Internal);
                Assert.NotNull(normal_Internal);

                Spatial.Classes.Vector3D? normal_External = polyhedron.GetNormal(i, Core.Enums.Side.External);
