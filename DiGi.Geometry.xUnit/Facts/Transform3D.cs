...
namespace DiGi.Geometry.xUnit
{
    public partial class Facts
    {
        ...
        public void Transform3D_Rotation()
        {
            ...
            Spatial.Classes.Vector3D vector3D_AxisZ = new(0.0, 0.0, 1.0);

            Spatial.Classes.Transform3D? transform3D_RotX = Create.Transform3D.Rotation(vector3D_AxisX, angle);
            Spatial.Classes.Transform3D? transform3D_RotY = Create.Transform3D.Rotation(vector3D_AxisY, angle);
            Spatial.Classes.Transform3D? transform3D_RotZ = Create.Transform3D.Rotation(vector3D_AxisZ, angle);

            Spatial.Classes.Transform3D transform3D_SpecX = Create.Transform3D.RotationX(angle);
            Spatial.Classes.Transform3D transform3D_SpecY = Create.Transform3D.RotationY(angle);
            Spatial.Classes.Transform3D transform3D_SpecZ = Create.Transform3D.RotationZ(angle);
            ...
            Spatial.Classes.Point3D point3D_1 = new(1.0, 0.0, 0.0);
            ...
            Spatial.Classes.Vector3D vector3D_Diag = new(1.0, 1.0, 1.0);
            double angle120 = 2.0 * System.Math.PI / 3.0;
            Spatial.Classes.Transform3D? transform3D_RotDiag = Create.Transform3D.Rotation(vector3D_Diag, angle120);
            Assert.NotNull(transform3D_RotDiag);

            Spatial.Classes.Point3D point3D_2 = new(1.0, 0.0, 0.0);
            ...
            Spatial.Classes.Point3D point3D_Origin = new(1.0, 0.0, 0.0);
            Spatial.Classes.Transform3D? transform3D_RotAroundPt = Create.Transform3D.Rotation(point3D_Origin, vector3D_AxisZ, angle);
            Assert.NotNull(transform3D_RotAroundPt);

            Spatial.Classes.Point3D point3D_3 = new(2.0, 0.0, 0.0);
        ...
        public void Transform3D_AdditionalFunctionalities()
        {
            ...
            Spatial.Classes.Vector3D vector3D_Orig = new(1.0, 2.0, 3.0);
            Spatial.Classes.Transform3D? transform3D_Translation = Create.Transform3D.Translation(10.0, 20.0, 30.0);
            ...
            Spatial.Classes.Point3D point3D_Orig = new(1.0, 2.0, 3.0);
            ...
            Spatial.Classes.Transform3D transform3D_Scale = Create.Transform3D.Scale(2.0, 3.0, 4.0);
            Spatial.Classes.Transform3D transform3D_Rotation = Create.Transform3D.RotationX(System.Math.PI / 4.0);
            Spatial.Classes.Transform3D? transform3D_Combined = transform3D_Translation * transform3D_Rotation * transform3D_Scale;

            Assert.NotNull(transform3D_Combined);

            Spatial.Classes.Vector3D? vector3D_DecTranslation;
            Spatial.Classes.Transform3D? transform3D_DecRotation;
            Spatial.Classes.Vector3D? vector3D_DecScale;
            ...
            Spatial.Classes.Transform3D transform3D_YPR = Create.Transform3D.RotationYawPitchRoll(yaw, pitch, roll);
            Spatial.Classes.Transform3D? transform3D_ManualYPR = Create.Transform3D.RotationZ(yaw) * Create.Transform3D.RotationY(pitch) * Create.Transform3D.RotationX(roll);
            ...
            // 5. Test ShearXY
            Spatial.Classes.Transform3D transform3D_Shear = Create.Transform3D.ShearXY(2.0, 3.0);
            Spatial.Classes.Point3D point3D_ShearTest1 = new(0.0, 0.0, 1.0);
            ...
            Spatial.Classes.Point3D point3D_ShearTest2 = new(1.0, 2.0, 0.0);
