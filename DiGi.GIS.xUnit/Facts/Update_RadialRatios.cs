...
namespace DiGi.GIS.xUnit
{
    ...
    {
        /// <summary>
        /// Verifies that the <see cref="IO.Modify.Update_RadialRatios(Table, IEnumerable{double}, int, Classes.Building2D, IEnumerable{Classes.Building2D}, double)"/> method correctly computes and updates radial ratios in a table.
