    ...
    public partial class Facts
    {
        ...
        public async Task YearBuiltDataController_TransientDatabaseFailure_Answers503()
        {
            ...
            try
            {
                ...
                AssertTransient503(controller, await controller.GetReferenceDuplicatesAsync(null));
                AssertTransient503(controller, await controller.GetCountyPartMismatchesAsync(null));
            }
            finally
            {
                System.IO.File.Delete(path);
