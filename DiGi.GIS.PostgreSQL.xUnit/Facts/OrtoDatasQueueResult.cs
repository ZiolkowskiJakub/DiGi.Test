...
namespace DiGi.GIS.PostgreSQL.xUnit
{
    public partial class Facts
    {
        ...
        public void OrtoDatasQueueResult_Serialization()
        {
            ...
            OrtoDatasQueueResult ortoDatasQueueResult = new(55417, 12_683, 9_412, 142, dateTimeOffset_First, dateTimeOffset_Last);
            ...
            Assert.Equal(142, ortoDatasQueueResult.AttemptedCount);
            ...
            Assert.Equal(142, ortoDatasQueueResult_Json.AttemptedCount);
            ...
            Assert.Equal(142, ortoDatasQueueResult_Clone.AttemptedCount);
