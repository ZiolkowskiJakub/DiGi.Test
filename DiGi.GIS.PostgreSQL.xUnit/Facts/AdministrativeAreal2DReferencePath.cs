...
namespace DiGi.GIS.PostgreSQL.xUnit
{
    public partial class Facts
    {
        ...
        /// <summary>
        /// Verifies that <see cref="AdministrativeAreal2DPostgreSQLConverter.GetAdministrativeAreal2DReferencePathsAsync(IEnumerable{AdministrativeAreal2DReference}, int, System.Threading.CancellationToken)"/>
